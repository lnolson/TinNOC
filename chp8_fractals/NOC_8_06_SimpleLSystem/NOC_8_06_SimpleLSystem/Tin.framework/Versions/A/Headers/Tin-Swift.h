...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC3Tin11TController")
@interface TController : NSViewController
- (void)viewWillAppear;
...
SWIFT_CLASS("_TtC3Tin6TScene")
@interface TScene : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC3Tin5TView")
